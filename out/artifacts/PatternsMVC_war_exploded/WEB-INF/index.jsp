...
<div class="container">
            ...
            <div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="showModalLabel">Show Pattern</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="alert alert-info" role="alert" id="info-text">
                                This is pattern demonstration:!
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <h1 style="text-align: center; margin-top: 50px; margin-bottom: 30px">Design Patterns</h1>
     ...
     <label style="float: right; margin-right: 10px" for="limit">Patterns in a page: </label>
...
<br>
    ...
    <button style="margin-bottom: 15px" type="button" class="btn btn-info" onclick="clickCreate()">Create new pattern</button>
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label for="inputDescriptionNew">Description</label>
                <input type="text" class="form-control" id="inputDescriptionNew" placeholder="Description">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-3">
                <label for="inputPatternType">Pattern type</label>
                <select id="inputPatternTypeNew" class="form-control">
                    <option selected>Creational</option>
        ...
        <div class="form-row">
            <div class="form-group col-md-6" style="padding: 0px 10px">
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadio2">Main</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioNew2"
                           value="false">
                    <label class="form-check-label" for="inlineRadio3">Additional</label>
                </div>
            </div>
        </div>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                <label for="inputPatternType">Pattern type</label>
                <select id="inputPatternType" class="form-control">
            ...
            <div class="form-group col-md-6" style="padding: 0px 10px">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3"
                           value="false">
                    <label class="form-check-label" for="inlineRadio3">Addtional</label>
                </div>
            </div>
        </div>
